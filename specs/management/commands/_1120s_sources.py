...
# Added 2026-08-25 (campaign D-45) so this module can do what every other loader
# can: contribute an excerpt to a row it does NOT own. Without it, moving a
# declaration into EXISTING_SOURCE_CODES would silently DROP its excerpts.
NEW_EXCERPTS_ON_EXISTING: list[tuple[str, dict]] = [    # Re-homed 2026-08-25 (campaign A3/D-42): IRC_1222 is DECLARED by load_1120s_family.py.
    ...
    # Re-homed 2026-08-25 (campaign A3/D-42): IRC_179 is DECLARED by load_1120s_family.py.
    # This spec still contributes these excerpts; it no longer rewrites the row.
    ("IRC_179", {
    ...
    # Re-homed 2026-08-25 (campaign A3/D-42): IRS_2025_1120S_SCHD_INSTR is DECLARED by load_1120s_family.py.
    # This spec still contributes these excerpts; it no longer rewrites the row.
    ("IRS_2025_1120S_SCHD_INSTR", {
    ...
    # Re-homed 2026-08-25 (campaign A3/D-42): IRS_2025_4562_INSTR is DECLARED by load_1120s_family.py.
    # This spec still contributes these excerpts; it no longer rewrites the row.
    ("IRS_2025_4562_INSTR", {
...
EXISTING_SOURCE_CODES = [
    ...
    "IRC_167",
    "IRC_197",
    "IRC_1222",  # ownership -> load_1120s_family.py (A3/D-42, 2026-08-25)
    "IRC_168",  # ownership -> load_1120s_family.py (A3/D-42, 2026-08-25)
    "IRC_179",  # ownership -> load_1120s_family.py (A3/D-42, 2026-08-25)
    "IRS_2025_1120S_SCHD_INSTR",  # ownership -> load_1120s_family.py (A3/D-42, 2026-08-25)
    "IRS_2025_4562_INSTR",  # ownership -> load_1120s_family.py (A3/D-42, 2026-08-25)
