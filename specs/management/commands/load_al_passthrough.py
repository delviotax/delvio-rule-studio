...
_AL_EPT = {
    ...
    "description": "W4. Act 2021-1. Electing PTE tax = 5% of the entity's Alabama taxable income, computed/paid on Form EPT (referenced on Form 65 Sch K L23 / Form 20S Sch K L25). Owner side = a REFUNDABLE CREDIT for the owner's share, claimed on the owner's OWN Alabama return (an upper-tier PTE owner carries it via Schedule CP-B -> Form EPT line 5d, verbatim: “Current Year's Composite Payment(s)/Electing Pass-Through Entity Credit(s) from Schedule CP-B, line 3”). NOT a deduction (contrast NC). [CORRECTED 2026-08-29 per D-16 AL-1] It is NOT Schedule EPT-C: the 2025 Schedule EPT-C is “Electing Pass-Through Credits ... ATTACH TO FORM EPT”, the ELECTING ENTITY's own incentive-credit schedule (2017 Historic Rehabilitation; Railroad Modernization Act of 2019), feeding Form EPT line 3 (Sec C) and line 5e (Sec D). [UNVERIFIED CLOSED 2026-08-29] The INDIVIDUAL owner claims it on SCHEDULE CP (Form 40 or 40NR), headed “Composite Payments/Electing PTE Credits” — Section B line 1 verbatim: “Total Composite Payment/Electing PTE Credits. Total of Column G enter here and on Form 40, page 1, line 26 or Form 40NR, page 1, line 23.” Form 40 line 26 reads “Payments from Schedule CP, Section B, Line 1”. ⚠ It is NOT Schedule OC / Form 40 line 25: Schedule OC Section F is a CLOSED list of five refundable credits (Accountability School-Transfer, Adoption, 2017 Historic Rehabilitation, Childcare Facility, Employer Provider) and F6 = F1+F2+F3+F4+F5 — no slot for the PTE credit. The symmetry: INDIVIDUAL owner → Schedule CP; UPPER-TIER PTE owner → Schedule CP-B. Source: 2025 Form 40 booklet (25f40.pdf, ModDate 2026-02-26), Schedule CP and Schedule OC Section F, read positionally. Corroborated internally by load_al_40nr.py's existing fact pte_credit_schedule_cp (“L23 Composite tax payments / Electing PTE credit (Schedule CP)”).",
}
_AL_COMPOSITE = {
